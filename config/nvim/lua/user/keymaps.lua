...
nnoremap("sl", "<C-w>l")
-- window management
nnoremap("<C-l>", "<C-w>l", { desc = "Change window to right" })
nnoremap("<C-h>", "<C-w>h", { desc = "Change window to left" })
nnoremap("<C-j>", "<C-w>j", { desc = "Change window to bottom" })
nnoremap("<C-k>", "<C-w>k", { desc = "Change window to top" })
nnoremap("<C-x>", "<cmd>close<CR>", { desc = "Close current split" })
